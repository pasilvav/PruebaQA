...
public class Tests_CerrarSesion {
    //Atributos
    private WebDriver driver;
    private HomePage homePage;
    private LoginPage loginPage;
    private CerrarSesion cerrarPage;
    ...
    public void preTests(){
        ...
        cerrarPage= new CerrarSesion(homePage.getDriver());
    ...
    public void CP_CerrarSesion(){
        ...
        //-------------------------
        dataCP2 = DataDriven.getData("CP019_Cerrar_Sesion");
        cerrarPage.esperarXSegundos(3000);
        cerrarPage.cerrarSesion();
        //-------------------------
        Assert.assertEquals(cerrarPage.obtenerUrlPagina(),dataCP2.get(1));
    }

    @AfterMethod
    public void postTests(){
        cerrarPage.cerrarBrowser();
